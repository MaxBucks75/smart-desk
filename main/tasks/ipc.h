/******************************************************************************
 * @file    ipc.h
 * @brief   Inter-process communication primitives used by tasks (queues, types)
 *****************************************************************************/
...
typedef enum { SENSOR_SOURCE_TEMP, SENSOR_SOURCE_FORCE, SENSOR_SOURCE_FP } sensor_source_t;
...
typedef enum { SET_FAN_SPEED, SET_DESK_HEIGHT, UPDATE_POWER, UPDATE_LED } control_cmd_t;
...
/**
 * @brief Initialize IPC primitives used across tasks (queues, mutex, shared structs).
 */
void ipc_init(void);